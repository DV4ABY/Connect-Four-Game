...
object Model {
    ...
    // Stores the position of piece that is to be dropped in the HBox. Used to convert to position in the
    // VBox below to help with smooth drop after mouse release
    var transXBeforeDrop = 0.0
    var transYBeforeDrop = 0.0
}